...
I built An accurate web & Chrome extension metronome you can use to practice with Youtube videos.
...
<div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 250px;">
    <ul>
      <li>Custom time signatures and note values.</li>
      <li>Beat subdivisions and adjustable accents for practicing complex rhythms.</li>
      <li>Tap tempo functionality for quickly syncing with external audio.</li>
    </ul>
  </div>
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="/assets/img/portfolio/metronome_online.png" alt="Metronome Online" style="max-width: 40%; height: auto; border-radius: 8px;">
  </div>
</div>
...
<div style="text-align: center; margin: 20px 0;">
  <img src="/assets/img/portfolio/percentage_calculator.png" alt="Percentage Calculator Screenshot" style="max-width: 40%; height: auto; border-radius: 8px;">
</div>
